...
const urlid = "c19798b8b9974ac683cec3a59750030d";

// this array will hold the audio samples
let audios = []

// Add your samples to the array. 
audios.push(document.getElementById('audio1'))
audios.push(document.getElementById('audio2'))
audios.push(document.getElementById('audio3'))
audios.push(document.getElementById('audio4'))
audios.push(document.getElementById('audio5'))
